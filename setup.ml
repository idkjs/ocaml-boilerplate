...
(* OASIS_START *)
(* DO NOT EDIT (digest: b8caca2daa6c5fff88b93ee5127322e4) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          bugreports = None;
          synopsis =
            "A command line tool to create a new ocaml project easily";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      lib_modules = ["Command"];
                      lib_pack = false;
                      lib_internal_modules = ["Message"; "Help"; "New"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "command"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/amolorsy/ocaml-boilerplate.git";
     ...
     oasis_digest = Some "=T\167\133\151\016>7\002h\1792@\\\2356";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
